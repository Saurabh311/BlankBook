...
<body>
	...
	<div class="container">
		...
		<div class="input-group mb-3">
			<form action="<%=request.getContextPath()%>/Search" method="post">
				<input name="search" type="text" class="form-control"
					placeholder="Write hashtag or message"
		...
		<div>
			...
			<form action="<%=request.getContextPath()%>/storyController"
				method="post">

				<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon1">#</span> <input
						type="text" required="required" color="blue" name="hashTag"
						class="form-control" placeholder="HashTag" aria-label="Username"
						aria-describedby="basic-addon1">
				</div>


				<div class="form-floating">
					<textarea name="story" required="required" class="form-control"
		...
		%>
		<form action="<%=request.getContextPath()%>/DeleteStoryController"
			method="post">
